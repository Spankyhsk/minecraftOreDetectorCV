...
from minecraft_ore_detector.imaging.segmentation import color_mask, supported_ores, hybrid_mask, edge_mask, use_edges_for_ore
...
def main():
    ...
    for ore in supported_ores():
        ...
        out_path = os.path.join(output_dir, f"{ore}_hybrid_mask.png")
